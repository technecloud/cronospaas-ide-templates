...
<#list clazz.primaryKeys as field>
   ...
   * @generated
   */    
  @Query("SELECT entity FROM ${clazz.name} entity WHERE <#list clazz.adjustedFullPrimaryKeys as field>entity.${field.pathName} = :${field.name}<#if field_has_next> AND </#if></#list>")
   ...
   *
<#list clazz.adjustedFullPrimaryKeys as field>
   * @param ${field.name}
   *          Identificador
</#list>
   ...
   */
  @Modifying
  @Query("DELETE FROM ${clazz.name} entity WHERE <#list clazz.adjustedFullPrimaryKeys as field>entity.${field.pathName} = :${field.name}<#if field_has_next> AND </#if></#list>")
...
<#list clazz.oneToManyRelation as relation>
  <#if relation.clazz.hasSearchableField()>
    ...
    <#list relation.clazz.fields as field>
      <#if field.isSearchable() && field.getType()=="java.lang.String" >
        <#if filter_index == 0>
          <#assign filter_query += "entity.${field.pathName} like concat('%',coalesce(:search,''),'%')" >
          <#assign filter_index++>
        <#else>
          <#assign filter_query += " OR entity.${field.pathName} like concat('%',coalesce(:search,''),'%')" >
        </#if>
      </#if>
    </#list>
   ...
   * @generated
   */
  @Query("SELECT entity FROM ${relation.clazz.name} entity WHERE <#list clazz.primaryKeys as field>entity.${relation.relationField.pathName}.${field.pathName} = :${field.name}<#if field_has_next> AND </#if></#list> AND (${filter_query})")
      ...
      <#if field.isSearchable() >
        <#if filter_index == 0>
          <#if field.getType()=="java.lang.String" >
            <#assign filter_query += "(:${field.name} is null OR entity.${field.pathName} like concat('%',:${field.name},'%'))" >
          <#else>
            <#assign filter_query += "(:${field.name} is null OR entity.${field.pathName} = :${field.name})" >
          </#if>
          <#assign filter_index++>
        <#else>
          <#if field.getType()=="java.lang.String" >
            <#assign filter_query += " AND (:${field.name} is null OR entity.${field.pathName} like concat('%',:${field.name},'%'))" >
          <#else>
            <#assign filter_query += " AND (:${field.name} is null OR entity.${field.pathName} = :${field.name})" >
          </#if>
        </#if>
      </#if>
    </#list>
   ...
   * @generated
   */
  @Query("SELECT entity FROM ${relation.clazz.name} entity WHERE <#list clazz.adjustedFullPrimaryKeys as field>entity.${relation.relationField.pathName}.${field.pathName} = :${field.name}<#if field_has_next> AND </#if></#list>")
  public Page<${relation.clazz.name}> find${relation.relationName?cap_first}(<#list clazz.adjustedFullPrimaryKeys as field>@Param(value="${field.name}") ${field.type} ${field.name}<#if field_has_next>, </#if></#list><#if clazz.primaryKeys?size gt 0>, </#if>Pageable pageable);
</#list>
<#list clazz.manyToManyRelation as relation>
  ...
  public Page<${relation.relationClassField.type}> list${relation.relationName?cap_first}GeneralSearch(@Param(value="search") java.lang.String search, <#list clazz.primaryKeys as field>@Param(value="${field.name}") ${field.type} ${field.name}<#if field_has_next>, </#if></#list><#if clazz.primaryKeys?size gt 0>, </#if>Pageable pageable);
    ...
    <#list relation.relationClass.fields as field>
      <#if field.isSearchable() >
        <#if filter_index == 0>
          <#if field.getType()=="java.lang.String" >
            <#assign filter_query += "(:${field.name} is null OR entity.${relation.relationClassField.name}.${field.name} like concat('%',:${field.name},'%'))" >
          <#else>
            <#assign filter_query += "(:${field.name} is null OR entity.${relation.relationClassField.name}.${field.pathName} = :${field.name})" >
          </#if>
          <#assign filter_index++>
        <#else>
          <#if field.getType()=="java.lang.String" >
            <#assign filter_query += " AND (:${field.name} is null OR entity.${relation.relationClassField.name}.${field.name} like concat('%',:${field.name},'%'))" >
          <#else>
            <#assign filter_query += " AND (:${field.name} is null OR entity.${relation.relationClassField.name}.${field.pathName} = :${field.name})" >
          </#if>
        </#if>
      </#if>
    </#list>
...
<#list clazz.fkFields as fkField>
   ...
   * @generated
   */
  @Query("SELECT entity FROM ${clazz.name} entity WHERE <#list fkField.relationClazz.adjustedFullPrimaryKeys as field>entity.${fkField.name?uncap_first}.${field.pathName} = :${field.name}<#if field_has_next> and </#if></#list>")
  public Page<${clazz.name}> find${clazz.name}sBy${fkField.name?cap_first}(<#list fkField.relationClazz.adjustedFullPrimaryKeys as field>@Param(value="${field.name}") ${field.type} ${field.name}<#if field_has_next>, </#if></#list>, Pageable pageable);
