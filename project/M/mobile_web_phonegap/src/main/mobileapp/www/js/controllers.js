(function($app) {
  ...
  app.controller('HomeController', [ '$scope', '$http', '$rootScope', '$state', '$translate', 'Notification', '$ionicHistory',
      function($scope, $http, $rootScope, $state, $translate, Notification, $ionicHistory) {
