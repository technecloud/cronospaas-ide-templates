  ...
  <nav class="navbar navbar-default"> 
    <div class="container-fluid"> 
      <div class="navbar-header"> 
        ...
        <a class="component-holder ng-binding ng-scope navbar-brand" data-component="crn-image" href="#/home"> <img src="plugins/cronapp-framework-js/img/logo-cronapp-negativa.svg" style="max-height:30px; margin-top:-5px" id="crn-navbar-logo" width="152px"> </a>
      </div> 
