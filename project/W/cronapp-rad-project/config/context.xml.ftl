...
<Context>
  ...
  <#else>
    <Resource accessToUnderlyingConnectionAllowed="true" 
        ...
        removeAbandonedTimeout="60" 
        logAbandoned="true" 
        url="jdbc:h2:file:~/${workCopyInfo.rootPath[workCopyInfo.rootPath?replace("/", "\\")?last_index_of("\\")+1..]};DATABASE_TO_UPPER=false;ALIAS_COLUMN_NAME=true;AUTO_SERVER=TRUE;FILE_LOCK=NO" />
  </#if>
</Context>