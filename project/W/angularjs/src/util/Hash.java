...
/**
 * Classe auxiliar para criptografar valores.
 */
public final class Hash {
	 ...
	 * @return String hash.
	 */
	private static String doMD5Hash(final String value) {
		try {
	 ...
	 * @return
	 */
	private static String doMD5WithSalt(final String value, final String salt) {
