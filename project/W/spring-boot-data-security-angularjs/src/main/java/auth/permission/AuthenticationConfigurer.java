...
/**
 * Classe que representa o componente customizado responsável pela autenticação
 * 
...
public class AuthenticationConfigurer implements AuthenticationProvider {
  ...
  /**
   * Contantes utilizadas para definir valores para administradores e usuários logados,
   * serão utilizadas no processo de criação da base inicial
   */
  ...
  /**
   * Método que criará a base inicial para o esquema de segurança
   */
  public void createDatabase() {
    ...
    permissionAdminRest.setPath("/api/rest/security/**").setVerb("ALL").setRole(roleAdmin).setPriority(1)
            .setEnabled(true);
  ...
  /**
   * Método customizado para autenticação de usuário
   */
  @Override
  ...
  /**
   * Valida se o objeto Authentication é suportado pelo provider
   */
  @Override
  ...
  /**
   * Recupera as autoridades concedidas para um usuário
   */
